...
CREATE TABLE `sdata` (
  ...
  `co2Level` int(2) NOT NULL,
  `smokeLevel` int(2) NOT NULL,
...
INSERT INTO `sdata` VALUES ('S20200504181127',2,8,2,2),('S20200504181221',0,0,4,5);
...
-- Dump completed on 2020-05-05  9:22:57
